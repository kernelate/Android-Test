...
*/
package com.ntek.wallpad.Services.Impl;
...
public class ScreenService extends NgnBaseService implements IScreenService {
	...
	public boolean back() {
		...
		if(mLastScreensIndex == 0){
			if((screen = mLastScreens[mLastScreens.length-1]) == null){
				// goto home TODO: for wallpad
				return show(FragmentPhone.class);
			}
			else{
	...
	public boolean bringToFront(int action, String[]... args) {
		Intent intent = new Intent(WallPad.getContext(), Main.class);
		try{
			...
			WallPad.getContext().startActivity(intent);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	@Override
	public boolean show(Class<? extends Activity> cls, String id, String[]... args) {
	...
	public boolean show(Class<? extends Activity> cls, String id) {
		return this.show(cls, id, null);
	}
	
	@Override
	public boolean show(Class<? extends Activity> cls, String[]... args) {
		return this.show(cls, null, args);
	}
	
	@Override
	public boolean show(Class<? extends Activity> cls) {
		return this.show(cls, null, null);
	}
