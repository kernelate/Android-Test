...
public class MaterialLockView extends View {
	...
	public MaterialLockView(Context context, AttributeSet attrs) {
		...
		mDotSize = dpToPx(20); //default is 12
	 ...
	 */
	 ...
	 private void startCellActivatedAnimation(Cell cell) 
	 {
		 ...
		 startSizeAnimation(mDotSize, mDotSizeActivated, 96, mLinearOutSlowInInterpolator, cellState, new Runnable()
		 {
			 ...
			 public void run()
			 {
				 startSizeAnimation(mDotSizeActivated, mDotSize, 200, mFastOutSlowInInterpolator, cellState, null); //default 192 dot animation end
			 }
		 });
