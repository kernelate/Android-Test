...
public abstract class BaseScreen extends Activity implements IBaseScreen {
	...
	public static enum SCREEN_TYPE {
		...
		// for WallPad TODO: Refactor after Las Vegas demo
		PHONE_FRAG_T,
		AUTOMATION_FRAG_T,
		GALLERY_FRAG_T,
		SETTINGS_FRAG_T
	...
	protected BaseScreen(SCREEN_TYPE type, String id) {
		...
		mType = type;
		mId = id;
		mScreenService = CommonUtilities.getScreenService();
	}
...
//		final IScreenService screenService = CommonUtilities.getScreenService();
