...
public class FragmentSetUpDoorTalkSelectUser extends Fragment {
	...
	protected void initializeUI() 
	{
		...
		sipsetupBtn = (Button) view.findViewById(R.id.phone_settings_button_sip_setup);
		callListBtn = (Button) view.findViewById(R.id.phone_settings_button_calllist);
		securityBtn = (Button) view.findViewById(R.id.phone_settings_button_security_functions);
		eventBtn = (Button) view.findViewById(R.id.phone_settings_button_event_settings);
		accntBtn = (Button) view.findViewById(R.id.phone_settings_button_account_setup);
		emailBtn = (Button) view.findViewById(R.id.phone_settings_button_email);
		...
		accntBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) 
			{
				...
				{ 
					mOnChangeFragment.changeFragment(null, new FragmentSettingsAccount(), true);
				}
			}
		});
		...
		sipsetupBtn.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				mOnChangeFragment.changeFragment(null, new FragmentSettingSipConfiguration(), true);
			}
		});
		...
		callListBtn.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
//				mOnChangeFragment.changeFragment(null, new FragmentSettingOutboundCall(), true);
				mOnChangeFragment.changeFragment(null, new FragmentSettingsCallList(), true);
		...
		securityBtn.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
//				mOnChangeFragment.changeFragment(null, new FragmentSettingSecurityFunction(mDeviceName), true);
				mOnChangeFragment.changeFragment(null, new FragmentSettingSecurityFunction(), true);
		...
		eventBtn.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				mOnChangeFragment.changeFragment(null, new FragmentSettingEventNotification(), true);
			}
		});
		...
		emailBtn.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				mOnChangeFragment.changeFragment(null, new FragmentSettingEmailNotification(), true);
			}
		});
