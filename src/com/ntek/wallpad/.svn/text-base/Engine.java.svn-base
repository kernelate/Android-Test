...
public class Engine extends NgnEngine{
	...
	private static final String CONTENT_TITLE = "Wallpad";
	...
	private void showNotification(int notifId, int drawableId, String tickerText) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(WallPad.getContext(), notifId/*requestCode*/, intent, PendingIntent.FLAG_UPDATE_CURRENT);     

        // Set the info for the views that show in the notification panel.
        notification.setLatestEventInfo(WallPad.getContext(), CONTENT_TITLE, tickerText, contentIntent);
